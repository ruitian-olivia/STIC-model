# Training Naive joint model for classifying HCC and ICC.
...
from CNN_RNN_model import VGG_model

os.environ["HDF5_USE_FILE_LOCKING"] = 'FALSE'

# Hyperparameter settings in Naive joint model
save_name = 'HI_joint'
clinical_flag = True
type_list=["HCC","ICC"]
resize=224
